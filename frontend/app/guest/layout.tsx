        ...
        return (
            <div className="flex min-h-screen items-center justify-center bg-slate-950 text-white">
                <div className="rounded-[28px] border border-white/10 bg-white/5 px-8 py-6 text-center">
                    ...
                    <h1 className="mt-3 text-2xl font-semibold">Loading guest portal</h1>
                    <p className="mt-2 text-sm text-slate-300">Validating your temporary session and access boundaries.</p>
                </div>
            </div>
        );
    }
