    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Admin', 'Admin'), ('Guest', 'Guest'), ('Lecturer', 'Lecturer'), ('Student', 'Student')], max_length=20)),
                ...
                ('bachelor_degree', models.FileField(blank=True, help_text='Upload bachelor degree document', null=True, upload_to='degrees/')),
